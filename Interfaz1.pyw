...
#frame1.config(width="400", height="300", border="5", relief="sunken")
...
botonDEL = Button(frame1, text="DEL", width=5, height=2, command=lambda: Funciones1.boton(texto, botonDEL))
botonDEL.grid(row=1, column=3, padx=5, pady=5, sticky="nsew")

botonAC = Button(frame1, text="AC", width=5, height=2, command=lambda: Funciones1.boton(texto, botonAC))
...
botonSCI = Button(frame1, text="SCI", width=5, height=2, bg="#2FF574")
botonSCI.grid(row=5, column=0, columnspan=2, padx=5, pady=5, sticky="nsew")

botonMATRIX = Button(frame1, text="MATRIX", width=5, height=2, bg="#D6FA33")
botonMATRIX.grid(row=5, column=2, columnspan=2, padx=5, pady=5, sticky="nsew")

botonGRAPH = Button(frame1, text="GRAPH", width=5, height=2, bg="#F95F2A")
